Week 10 Tutorial: Exception Handling
...
Setup
git clone https://github.com/sukhrobyangibaev/campuspass-ticketing
...
Validates the input (use parse_booking_request from validators)
Reserves tickets on the event (calls event.book(...))
Calculates the total price from the tier
Charges the payment through the gateway (if the gateway is not None and the price is greater than 0)
Returns a booking summary dict on success with keys: email, event_id, event_name, tier, quantity, and total_price
...
Report a bug or suggest an improvement: Open an issue
Submit your own fix or feature:
Fork this repository
Clone your fork: git clone https://github.com/<your-username>/campuspass-ticketing.git
Create a branch, make your changes, and push: git push origin your-branch-name
Open a pull request from your fork back to this repo